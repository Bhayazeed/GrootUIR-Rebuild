    ...
    <div class="admin-container">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          ...
          <input type="text" v-model="formData.description" placeholder="Masukkan desc..." />
        </div>

        <div class="form-group">
          <label>Category</label>
          <input type="text" v-model="formData.category" placeholder="Masukkan cate..." />
        </div>

        <div class="form-group">
          <label>Pilih Tanggal</label>
          <input type="date" v-model="formData.created_at" />
        </div>
